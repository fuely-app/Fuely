...
actor API {
    ...
    enum Brand : String, CaseIterable, Codable, Comparable {
        ...
        var colour: UIColor {
            switch self {
            case .vibe: .init(red: 0.86, green: 0.11, blue: 0.27, alpha: 1.0)
            case .costco: .init(red: 0.88, green: 0.11, blue: 0.20, alpha: 1.0)
            case .atlas: .init(red: 0.00, green: 0.35, blue: 0.66, alpha: 1.0)
            case .burk: .init(red: 0.96, green: 0.72, blue: 0.16, alpha: 1.0)
            case .xConvenience: .init(red: 0.00, green: 0.68, blue: 0.31, alpha: 1.0)
            case .liberty: .init(red: 0.11, green: 0.22, blue: 0.54, alpha: 1.0)
            case .shell: .init(red: 1.00, green: 0.84, blue: 0.00, alpha: 1.0)
            case .united: .init(red: 0.00, green: 0.44, blue: 0.75, alpha: 1.0)
            case .caltex: .init(red: 0.00, green: 0.39, blue: 0.33, alpha: 1.0)
            case .petroFuels: .init(red: 0.94, green: 0.43, blue: 0.00, alpha: 1.0)
            case .sevenEleven: .init(red: 0.00, green: 0.60, blue: 0.44, alpha: 1.0)
            case .fastFuel247: .init(red: 0.00, green: 0.67, blue: 0.88, alpha: 1.0)
            case .egAmpol: .init(red: 0.84, green: 0.00, blue: 0.18, alpha: 1.0)
            case .ampol: .init(red: 0.93, green: 0.00, blue: 0.14, alpha: 1.0)
            case .independent: .init(red: 0.25, green: 0.25, blue: 0.25, alpha: 1.0)
            case .metroPetroleum: .init(red: 0.96, green: 0.69, blue: 0.00, alpha: 1.0)
            case .ugo: .init(red: 0.00, green: 0.59, blue: 0.53, alpha: 1.0)
            case .omgCaltex: .init(red: 0.89, green: 0.00, blue: 0.24, alpha: 1.0)
            case .bp: .init(red: 0.00, green: 0.65, blue: 0.13, alpha: 1.0)
            case .betterChoice: .init(red: 0.00, green: 0.54, blue: 0.77, alpha: 1.0)
            case .reddyExpress: .init(red: 0.91, green: 0.00, blue: 0.14, alpha: 1.0)
            case .astron: .init(red: 0.44, green: 0.00, blue: 0.77, alpha: 1.0)
            }
        }
    ...
    struct Item : Codable, Hashable, Comparable {
        static func < (lhs: API.Item, rhs: API.Item) -> Bool {
            lhs.tradingName.localizedCaseInsensitiveCompare(rhs.tradingName) == .orderedAscending
        }
