...
class SceneDelegate : UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        let locationAccessGranted: Bool = UserDefaults.standard.bool(forKey: "fuely.2.0.locationAccessGranted")
        ...
        window.rootViewController = if locationAccessGranted && onboardingComplete {
            ...
            controller(onboardingModel, locationAccessGranted, onboardingComplete)
        }
    ...
    func controller(_ onboardingModel: OnboardingModel, _ cameraAccessGranted: Bool, _ onboardingComplete: Bool) -> UIViewController {
        ...
        return if !cameraAccessGranted && onboardingComplete {
            settingsController
        } else {
